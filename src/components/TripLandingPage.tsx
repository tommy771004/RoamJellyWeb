        ...
        >
          <div className="overflow-hidden rounded-[30px] border border-white/92 bg-[linear-gradient(180deg,rgba(255,255,255,0.90),rgba(255,250,251,0.80),rgba(241,248,255,0.78))] p-4 shadow-[0_18px_42px_rgba(15,23,42,0.10)] backdrop-blur-xl sm:p-6">
            ...
            <button
              ...
              disabled={joining}
              className={cn(
                'mt-6 flex min-h-12 w-full items-center justify-center gap-2 rounded-full px-5 py-3 text-[14px] font-black tracking-[0.08em] text-white transition-all duration-300 ease-[cubic-bezier(0.34,1.56,0.64,1)] ios-press',
                joining
