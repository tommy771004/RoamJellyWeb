...
export default function HomeTab({
  ...
  return (
    ...
    >
      ...
      <div
        className={`relative z-10 w-full pt-9 sm:pt-[68px] ${!isHeroExpanded ? "pb-3" : "pb-8 sm:pb-12"} px-3 sm:px-6 overflow-visible`}
      >
        <motion.div 
        ...
        <div className="relative z-20 mx-auto w-full max-w-[1120px]">
          ...
          <motion.div
            ...
            className={`group relative mx-auto mb-4 max-w-[980px] space-y-3 overflow-hidden rounded-[34px] section-shell soft-glow px-4 py-4 text-center sm:mb-5 sm:space-y-4 sm:px-6 sm:py-6${!isHeroExpanded ? " hidden sm:block" : ""} cursor-pointer transition-colors duration-300 hover:bg-white/40`}
          >
            ...
            <div className="flex flex-wrap items-center justify-center gap-2 sm:gap-3">
              <span className="jelly-chip inline-flex items-center rounded-full px-3.5 py-1.5 text-[10px] font-black uppercase tracking-[0.24em] text-sky-700 shadow-[0_6px_14px_rgba(14,165,233,0.07)] backdrop-blur-md">
                Collaborative Trip Planner
              </span>
              <span className="hidden jelly-chip items-center rounded-full px-3 py-1 text-[10px] font-black uppercase tracking-[0.24em] text-orange-500 shadow-[0_6px_14px_rgba(249,115,22,0.07)] backdrop-blur-md sm:inline-flex">
                Cute Flow
              </span>
              <ChevronDown size={14} className={`text-slate-400 transition-transform duration-300 ${!isHeroIntroCollapsed ? "rotate-180" : ""}`} />
            </div>
            <div className="relative space-y-2 sm:space-y-3">
              <p className={`text-[10px] font-black uppercase tracking-[0.28em] text-pink-500/80 transition-all duration-300 ${isHeroIntroCollapsed ? "hidden" : "block"}`}>
                Premium Jelly Journey Desk
              </p>
              <h1 className="candy-title mx-auto max-w-4xl text-balance text-[30px] font-black tracking-[-0.05em] text-slate-900 sm:text-[44px] md:text-[58px] md:leading-[1.01]">
                把航班、地圖與旅伴分工，收進同一份旅程
              </h1>
              ...
              <AnimatePresence initial={false}>
                {!isHeroIntroCollapsed && (
                  ...
                  >
                    <p className="mx-auto max-w-[40rem] text-pretty text-[14px] font-medium leading-[1.75] text-slate-600 sm:text-[15px] sm:leading-[1.82]">
                      ...
                      <div className="flex snap-x gap-2 overflow-x-auto pb-1 text-left sm:grid sm:grid-cols-3 sm:gap-3 sm:overflow-visible sm:pb-0 pt-2">
                        {HERO_STORY_PILLARS.map((pillar, index) => {
                          ...
                          return (
                            <div
                              key={pillar.title}
                              className={`group/pillar section-shell hover-float relative min-w-[248px] snap-start overflow-hidden rounded-[28px] px-3.5 py-3 backdrop-blur-xl sm:min-w-0 ${decor.shell}`}
                            >
                              ...
                              <div className="editorial-divider relative mt-3 flex items-center justify-between gap-3 pt-3">
                                ...
                                <button
                                  ...
                                  className="jelly-chip hover-float inline-flex shrink-0 items-center gap-1 rounded-full px-3 py-1.5 text-[11px] font-black text-slate-600 shadow-sm active:scale-[0.96] hover:border-sky-200 hover:text-sky-700 hover:shadow-md"
                                >
                                  查看說明
          ...
          >
            ...
            {!isHeroExpanded && (
              <button
                ...
                className="section-shell soft-glow relative z-20 md:hidden w-full flex items-center gap-2.5 rounded-[28px] px-4 py-3 shadow-[0_12px_30px_rgba(14,165,233,0.12)] backdrop-blur-[20px]"
              >
            ...
            {isHeroExpanded && (
              <div className="relative z-20">
                <div className="mb-2.5 flex flex-col items-start gap-1.5 px-1 sm:mb-3 sm:flex-row sm:flex-wrap sm:items-center sm:justify-between sm:gap-3">
                  ...
                  {!isLoggedIn && (
                    <span className="jelly-chip inline-flex items-center rounded-full px-3 py-1 text-[11px] font-black tracking-[0.18em] text-slate-600 uppercase backdrop-blur-md">
                      訪客也能先建立旅程
                    </span>
                  )}
                </div>
                {/* Trip type toggle */}
                <div className="jelly-chip mb-2.5 flex w-fit items-center gap-1 rounded-full p-1">
                  <button
                ...
                {/* Search card */}
                <div className="section-shell soft-glow flex flex-col gap-2 rounded-[32px] sm:rounded-[40px] p-2.5 sm:gap-2 sm:p-3.5">
                  {/* FROM / TO row */}
