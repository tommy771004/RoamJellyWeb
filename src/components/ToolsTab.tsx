    ...
    return (
      <div className="flex-1 overflow-y-auto bg-transparent px-3 py-5 pb-[max(1.5rem,env(safe-area-inset-bottom))] scroll-smooth sm:px-6 sm:py-6">
        <motion.div
          ...
          className="section-shell soft-glow mx-auto my-auto w-full max-w-5xl overflow-hidden rounded-[34px] sm:rounded-[40px] sm:p-8 md:p-10"
        >
          ...
          <div className="grid gap-6 md:grid-cols-[1.1fr_0.9fr] md:items-center">
            <div className="space-y-5 text-center md:text-left">
              <div className="jelly-chip inline-flex items-center rounded-full px-3.5 py-1.5 text-[11px] font-black uppercase text-sky-700">
                旅程工具包
              </div>
              <div className="space-y-2.5 sm:space-y-3">
                <h2 className="candy-title text-balance text-[30px] font-black leading-tight text-slate-900 sm:text-[36px] md:text-[42px]">
    ...
    >
      <div className="pt-4 sm:pt-8 pb-tab-safe px-3 sm:px-8 md:px-12 lg:px-16 xl:px-24 mx-auto flex flex-col w-full max-w-full sm:max-w-xl md:max-w-3xl lg:max-w-5xl xl:max-w-6xl gap-y-6 sm:gap-y-10">
        ...
        <motion.section
          ...
          className="section-shell soft-glow relative overflow-hidden rounded-[32px] sm:p-5"
        >
          ...
          <div className="relative flex flex-col gap-4">
            <div className="flex flex-col gap-3 lg:flex-row lg:items-end lg:justify-between">
              ...
              <button
                ...
                className="jelly-chip hover-float inline-flex min-h-11 items-center justify-center gap-2 rounded-full px-5 py-3 text-sm font-black text-slate-700 shadow-sm hover:border-sky-200 hover:text-sky-700"
              >
                回到旅程手帳
            ...
            <div className="grid gap-2.5 sm:grid-cols-3">
              {toolHighlights.map(({ icon: Icon, label, value, description }, index) => {
                ...
                <div
                  key={label}
                  className={`section-shell hover-float relative overflow-hidden rounded-[24px] px-3.5 py-3 ${decor.shell}`}
                >
