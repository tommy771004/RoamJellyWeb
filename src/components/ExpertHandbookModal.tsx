      ...
      {open && (
        ...
        >
          ...
          <motion.div
            ...
            className="relative flex max-h-modal-dvh w-full flex-col overflow-hidden rounded-t-[32px] sm:rounded-[40px] border border-white/72 dark:border-white/10 bg-white/80 dark:bg-slate-900/80 backdrop-blur-[32px] shadow-[0_28px_64px_rgba(15,23,42,0.16)] dark:shadow-[0_28px_64px_rgba(0,0,0,0.6)] sm:max-w-3xl sm:rounded-[36px] md:max-w-4xl outline-none"
            onClick={(e) => e.stopPropagation()}
          >
            {/* Header */}
            <div className="z-20 flex-shrink-0 border-b border-white/40 dark:border-white/10 bg-white/40 dark:bg-slate-900/40 px-5 pb-4 pt-5 backdrop-blur-xl sm:px-7 sm:pt-6">
