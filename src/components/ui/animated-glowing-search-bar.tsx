        ...
        <div id="main" className="relative group w-full flex items-center bg-white/90 backdrop-blur-md rounded-[16px] shadow-sm border border-slate-200 focus-within:border-fuchsia-300 transition-all focus-within:ring-2 focus-within:ring-fuchsia-400/20">
          ...
          <div className="pr-2 flex items-center justify-center">
            <button
               ...
               aria-label="送出"
               className="flex h-9 w-9 items-center justify-center rounded-full bg-gradient-to-tr from-fuchsia-600 to-sky-600 text-white transition-all ios-press disabled:bg-slate-200 disabled:from-slate-200 disabled:to-slate-300 disabled:text-slate-400 z-10 shadow-sm"
             >
