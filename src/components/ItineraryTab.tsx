      ...
      <div className="max-w-[1440px] mx-auto w-full pb-tab-safe md:px-4 lg:px-8 mt-0 sm:mt-4 md:mt-6">
        ...
        <div className="relative w-full h-[20vh] sm:h-[30vh] md:h-64 overflow-hidden md:rounded-[40px] mb-4 md:mb-8 print:hidden -mt-4 md:mt-0 shadow-[0_8px_30px_rgb(0,0,0,0.12)] z-10 sm:max-w-[calc(100%-2rem)] sm:mx-auto">
          ...
          <div className="absolute top-8 left-5 right-5 flex justify-end items-start z-50 lg:hidden">
            <div className="flex gap-2.5">
              <button
                ...
                className="hover-float px-4 h-11 bg-white/18 hover:bg-white/28 backdrop-blur-xl border border-white/35 rounded-full flex items-center justify-center text-white transition-all active:scale-95 shadow-[0_14px_24px_-16px_rgba(15,23,42,0.45)] text-[11px] font-black uppercase tracking-widest disabled:opacity-60"
              >
              ...
              <button
                onClick={handleShare}
                aria-label="分享行程"
                className="hover-float w-11 h-11 bg-white/18 hover:bg-white/28 backdrop-blur-xl border border-white/35 rounded-full flex items-center justify-center text-white transition-all active:scale-95 shadow-[0_14px_24px_-16px_rgba(15,23,42,0.45)]"
              >
          ...
          <div className="absolute bottom-8 left-6 right-6 lg:hidden flex flex-col gap-3 z-50">
            <h1 className="candy-title text-[42px] sm:text-5xl font-black text-slate-800 leading-[0.96] drop-shadow-sm tracking-tight line-clamp-2 text-balance">
            ...
            <div className="flex items-center gap-2 text-slate-700 font-black text-[11px] uppercase tracking-widest flex-wrap">
              <span className="jelly-chip bg-white/95 backdrop-blur-xl px-3.5 py-1.5 rounded-full shadow-[0_2px_10px_-4px_rgba(0,0,0,0.1)]">
                {totalDays} DAYS
              </span>
              <span className="jelly-chip bg-white/95 backdrop-blur-xl px-3.5 py-1.5 rounded-full shadow-[0_2px_10px_-4px_rgba(0,0,0,0.1)]">
              ...
              <span
                className={`jelly-chip backdrop-blur-xl px-3.5 py-1.5 rounded-full shadow-[0_2px_10px_-4px_rgba(0,0,0,0.1)] ${tripInfo?.isPublic ? "bg-emerald-100/95 text-emerald-700" : "bg-white/95 text-slate-500"}`}
              >
          ...
          <div className="group w-full md:w-auto">
            <div className="hidden lg:flex items-center gap-2 mb-4 flex-wrap">
              <button
                ...
                className="jelly-chip hover-float px-4 py-2 rounded-xl text-[11px] font-black text-slate-500 transition-all uppercase tracking-widest flex items-center gap-2 shadow-sm active:scale-95"
              >
              ...
              <button
                onClick={handleShare}
                className="jelly-chip hover-float px-4 py-2 rounded-xl text-[11px] font-black text-pink-500 transition-all uppercase tracking-widest flex items-center gap-2 shadow-sm active:scale-95"
              >
              ...
              <button
                onClick={handleTogglePublicTemplate}
                disabled={isUpdatingPublicState}
                className={`jelly-chip hover-float px-4 py-2 rounded-xl text-[11px] font-black transition-all uppercase tracking-widest flex items-center gap-2 shadow-sm active:scale-95 disabled:opacity-60 ${tripInfo?.isPublic ? "bg-emerald-50 hover:bg-emerald-100 text-emerald-600" : "text-slate-500"}`}
              >
              ...
              <button
                ...
                className="jelly-chip hover-float px-4 py-2 rounded-xl text-[11px] font-black text-emerald-600 transition-all uppercase tracking-widest flex items-center gap-2 shadow-sm active:scale-95"
              >
              ...
              <button
                ...
                className="jelly-chip hover-float px-4 py-2 rounded-xl text-[11px] font-black text-slate-500 transition-all uppercase tracking-widest flex items-center gap-2 shadow-sm active:scale-95 print:hidden"
              >
            ...
            <div className="hidden lg:block mt-8">
              <h1 className="candy-title text-5xl lg:text-6xl font-black text-slate-800 mb-4 flex items-center gap-3 tracking-tight leading-tight">
              ...
              <div className="flex flex-col sm:flex-row sm:items-center gap-3 sm:gap-4 text-slate-500 font-bold text-[14px]">
                <div className="jelly-chip hover-float flex items-center gap-2 px-4 py-1.5 rounded-full shadow-sm">
                ...
                <div
                  className={`jelly-chip hover-float flex items-center gap-2 px-4 py-1.5 rounded-full shadow-sm ${tripInfo?.isPublic ? "bg-emerald-50/60 border-emerald-100/60" : ""}`}
                >
                  <Share2
                    size={16}
                    className={
                      ...
                      <GlassCard className="!p-6 !rounded-[32px] border border-white/80 shadow-xl overflow-hidden">
                        <div className="flex flex-col sm:flex-row items-center justify-between gap-6">
                          ...
                          <button
                            ...
                            className={`w-full sm:w-auto px-10 py-4 rounded-full font-black text-sm tracking-widest uppercase transition-all flex items-center justify-center gap-3 ${showPlanner ? "bg-slate-100 text-slate-500" : "bg-slate-800 text-white hover:bg-slate-900 shadow-xl shadow-slate-200 active:scale-95"}`}
                          >
                            ...
                            >
                              <div className="pt-10 flex flex-col gap-6">
                                ...
                                <button
                                  ...
                                  disabled={aiLoading}
                                  className="w-full py-5 px-4 rounded-full bg-gradient-to-r from-pink-500 via-fuchsia-600 to-indigo-600 text-white font-black text-sm uppercase tracking-[0.2em] shadow-2xl shadow-pink-200/50 flex flex-nowrap items-center justify-center gap-3 disabled:opacity-50 active:scale-[0.98] transition-all whitespace-nowrap overflow-hidden text-ellipsis"
                                >
