      ...
      >
        ...
        <div className="flex items-center justify-between px-5 py-3.5 gap-3 bg-slate-50/50">
          ...
          <div className="flex items-center gap-2 flex-shrink-0">
            ...
            <button
              onClick={() => setOpen((v) => !v)}
              className={`fluid-caption flex items-center gap-1.5 rounded-full px-3.5 py-1.5 font-black transition-all duration-300 ease-[cubic-bezier(0.34,1.56,0.64,1)] ios-press shadow-sm whitespace-nowrap ${
                open
