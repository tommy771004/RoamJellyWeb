        ...
        {needsAuth ? (
          ...
          <div className="flex flex-col gap-4">
            ...
            <button
              ...
              disabled={isCreating}
              className="flex w-full items-center justify-center gap-2 rounded-[16px] py-3 text-[14px] font-black shadow-sm transition-all duration-300 bg-violet-700 text-white hover:bg-violet-800 ios-press"
            >
              {isCreating ? (
