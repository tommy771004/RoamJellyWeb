...
const itineraries = [
  ...
  },
  {
    ...
    nodes: [
      ...
      { node_id: 'hb_1_6', day: 3, time: '18:00', title: 'Iconsiam 暹羅天地', emoji: '🏢', category: 'shopping', description: '結合室內水上市場的超級百貨', lat: 13.7265, lng: 100.5103, source: 'local' },
  ...
  },
  {
    ...
    nodes: [
      ...
      { node_id: 'hb_14_6', day: 5, time: '10:00', title: '瓦洛洛市場', emoji: '🛍️', description: '買泰北香料、果乾伴手禮', lat: 18.7901, lng: 99.0007, source: 'local' }
    ]
  },
  {
    id: 1015,
  ...
  },
  {
    ...
    nodes: [
      ...
      { node_id: 'hb_19_6', day: 6, time: '22:00', title: '追逐極光', emoji: '✨', category: 'activity', description: '夜晚遠離光害尋找神祕歐若拉', lat: 64.1283, lng: -21.8277, source: 'local' }
    ]
  },
  {
    id: 1020,
    ...
    nodes: [
      ...
      { node_id: 'hb_20_4', day: 3, time: '14:00', title: '烏布傳統市場', emoji: '🛍️', category: 'shopping', description: '買藤編包與藝術紀念品', lat: -8.5069, lng: 115.2625, source: 'local' },
      { node_id: 'hb_20_5', day: 4, time: '15:00', title: '金巴蘭海灘晚餐', emoji: '🦞', category: 'food', description: '沙灘上的浪漫海鮮BBQ', lat: -8.7663, lng: 115.1689, source: 'local' }
    ]
  }
];

fs.writeFileSync('src/data/expertHandbooks.json', JSON.stringify(itineraries, null, 2), 'utf-8');
console.log('Successfully generated 21 handbooks to src/data/expertHandbooks.json');
